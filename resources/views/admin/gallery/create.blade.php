    ...
    <div class="w-full min-h-screen">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-3 mb-2">
                ...
                <h1 class="text-2xl font-semibold text-gray-900">Tambah Foto Baru</h1>
            </div>
        </div>
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-xl border border-gray-100 p-6">
                        ...
                        <div>
                            ...
                            <div
                                class="border-2 border-dashed border-gray-200 rounded-lg p-6 text-center hover:border-indigo-300 transition-colors">
                                <div class="mb-3">
                            ...
                            <div class="flex items-start space-x-3 p-4 bg-gray-50 rounded-lg">
                                <div class="flex items-center h-5">
                                    ...
                                    <input type="checkbox" name="is_featured" value="1" id="is_featured"
                                        {{ old('is_featured', $image->is_featured ?? true) ? 'checked' : '' }}
