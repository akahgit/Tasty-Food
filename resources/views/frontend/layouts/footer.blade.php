    ...
    <div class="grid grid-cols-1 gap-6 px-4 mx-auto max-w-7xl sm:grid-cols-2 md:grid-cols-4 sm:gap-8">
        ...
        <div class="md:col-span-1">
            ...
            <div class="flex gap-3 mt-4">
                <a href="#" class="flex items-center justify-center w-6 h-6 bg-blue-600 rounded-full sm:w-8 sm:h-8">
                    <img src="{{ asset('images/001-facebook.webp') }}" alt="" class="w-3 h-3">
                </a>
                <a href="#" class="flex items-center justify-center w-6 h-6 rounded-full sm:w-8 sm:h-8 bg-sky-500">
                    <img src="{{ asset('images/002-twitter.webp') }}" alt="" class="w-3 h-3">
                </a>
            </div>
        </div>
        ...
        <div class="md:col-span-1">
            ...
            <ul class="mt-4 space-y-2 text-xs text-gray-400 sm:space-y-3 md:space-y-4 lg:space-y-5 sm:text-sm">
        ...
        <div class="md:col-span-1">
            ...
            <ul class="mt-4 space-y-2 text-xs text-gray-400 sm:space-y-3 md:space-y-4 lg:space-y-5 sm:text-sm">
                <li class="flex items-center gap-2">
                    <img src="{{ asset('images/ic_markunread_24px.webp') }}" alt="" class="w-4 h-4">
                    <span class="break-all">tastyfood@gmail.com</span>
                </li>
                <li class="flex items-center gap-2">
                    <img src="{{ asset('images/ic_call_24px.webp') }}" alt="" class="w-4 h-4">
                    +62 812 3456 7890
                </li>
                <li class="flex items-center gap-2">
                    <img src="{{ asset('images/ic_place_24px.webp') }}" alt="" class="w-4 h-4">
